...
```		
Once you've reached the bottom of the Bomb room **Elevator** having never lost any Shield, when the loud-speaker cycles through next and notices Megg is available, it will play it. This usually takes 10-35 seconds *[12.5-20 seconds [non-H2C](../../Bugs/ScriptIterationTiming.md)] from when "Return to Sender" text starts fading onto the screen. Though it can be hard to hear, it will say;
